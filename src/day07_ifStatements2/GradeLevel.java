...
public class GradeLevel {
    public static void main(String[] args) {
        ...
        if (gradeLevel <= 5){
            result ="Your child is in Elementary school";
        }
        else if ( gradeLevel <= 8){
            result ="Your child is in Middle school";
        }
        else if (gradeLevel <= 12){
            result = "Your child is in High school";
        }
        else if ( gradeLevel <= 16){
            result = "Your child is in College";
        }
        else {
            result = " Your child is in Grad school";
        }
