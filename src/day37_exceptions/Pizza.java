...
public class Pizza {
    ...
    public boolean equals(Object obj) {
        if(!(obj instanceof Pizza)){ // precondition to make sure that the obj is pizza
            System.err.println("Invalid object: "+obj);
            System.exit(1);
        }

        Pizza pizza = (Pizza) obj; // downcasting is done more than one time we can assign the variable
